...
export const Counter = () => {
    ...
    arrayNormal.forEach((number) => {
      arrayNormal.forEach((string) => {
        arrayNormal.forEach((str) => {
          arrayNormal.forEach((teste) => {
            arrayNormal.forEach((testeTwo) => {
              arrayNormal.forEach((tete7) => {
                if (number === string && string === str) {
                  console.log(number);
                }

                if (number === teste && string === teste) {
                  console.log(number);
                }

                if (tete7 === tete7 && testeTwo === str) {
                  console.log(number);
                }
                while (true) {
                  console.log('ALALA');
  ...
  return (
    <div>
      ...
      <button onClick={TestingSonar}>Clique aqui</button>
    </div>
  );
};
